  ...
  render() {
    ...
    return (
      ...
      <div className={className} style={{display:'flex',flexDirection:'column'}}>
        ...
        <p style={{fontSize:'20px',position:'fixed',textAlign:'left',marginLeft:'-448px',marginTop:'51px',width:'300px',height:'300px'}}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Distinctio laudantium repellendus dicta minima excepturi necessitatibus praesentium minus ex qui! Tempora commodi quia placeat molestias quidem tenetur illum! Qui, itaque dolorum.Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, maxime. Quod eius non cum molestias eum quaerat eos et similique.</p>
        </div>   
      }
